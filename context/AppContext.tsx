...
interface AppContextType {
  ...
  playlistSongs: any[];
  setPlaylistSongs: React.Dispatch<React.SetStateAction<any[]>>;
  currentIndex: number;
  setCurrentIndex: React.Dispatch<React.SetStateAction<number>>;
  modoReproduccion:number;
  setModoReproduccion: React.Dispatch<React.SetStateAction<number>>;
  singleLoop: boolean;
  setSingleLoop: React.Dispatch<React.SetStateAction<boolean>>;
  currentTrack: any;
  setCurrentTrack: React.Dispatch<React.SetStateAction<any>>;
  lastRouteRef: React.RefObject<string | null>;
